...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 30 Sep 2022 pada 15.34
...
INSERT INTO `tb_mhs` (`id`, `nama`, `alamat`, `tempat_lahir`, `tanggal_lahir`, `kota_asal`, `jenis_kelamin`) VALUES
(4, 'Bagaskara', 'Bagaskoro', 'BandarLampung', '2000-08-21', 'bandarlampung', 'Laki-laki'),
(5, 'Putri Linda Okfriyani', 'Gang Damai', 'WayHuwi', '2001-10-13', 'Way Huwi', 'Perempuan'),
(7, 'Muhammad Bagaskara', 'Jl.Tirtasari', 'Wayhuwi', '2000-08-21', 'Bandarlampung', 'Laki-laki');
...
CREATE TABLE `tb_mahasiswa` (
  ...
  `jurusan` enum('IF','SI','TK','TI','SIA') COLLATE latin1_general_ci NOT NULL
...
(1, '19312112', 'Bagaskara ', 'bagaskara148@gmail.com', 'Informatika', '633464673d22e.png'),
(2, 'jasjasjj', 'ajsjasj', 'jsajsjaj', 'jsjajsaj', '633464ed794f6.png');
...
('root', '[{\"db\":\"db_pwbs_gab2\",\"table\":\"tb_mahasiswa\"}]');
...
('root', '2022-09-30 13:23:02', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"id\"}');
